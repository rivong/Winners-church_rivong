!(function (t) {
  ...
  if (
    ...
    t(".vertical-counter").length > 0 &&
      t(document).on("appear", ".vertical-counter", function (e) {
        t(window).scrollTop() + z() >= t(".vertical-counter").offset().top &&
          t(this)
    ...
    document.querySelectorAll(".instafeed-wrapper").forEach(function (e, a) {
      var o =
          "IGQWRONUZA1alpfTlRaZAVVUWnc5S3VwbklrZADVsYVgwTHBGZAXYzTEs2ZAXE4V25FQTRxY2oyYzdXYlcxbDV4YmVCblhsRHZAXT01IRDFjNlBTQW1hMU5IZAUJCX25IQ3luV1VXbmszTTZAXZAFFaNnhuZAndfZAWJ0Y25iVU0ZD",
        i = t(e),
      ...
      null != r && i.html(""),
        t.ajax({
          url:
            "https://graph.instagram.com/me/media?fields=id,caption,media_type,media_url,username,timestamp,permalink,thumbnail_url&access_token=" +
            o,
          type: "GET",
          success: function (a) {
            for (var o in ((l +=
              i.find(".grid-item").length > 0
            ...
            a.data))
              if (o < parseInt(n) && "IMAGE" == a.data[o].media_type) {
                var d = a.data[o].permalink || "",
                  ...
                  g = s;
                (g = (g = (g = (g = (g = (g = (g = (g = g.replace(
                  ' href="#"',
                  ""
                )).replace(' src="#"', "")).replace(
                  "data-href",
                  "href"
                )).replace("data-src", "src")).replace("{{link}}", d)).replace(
                  "{{image}}",
                  p
                )).replace("{{likes}}", u)).replace("{{comments}}", m)),
                  (l += g);
              }
            if ((i.html(l), null != r)) {
              var f = t.parseJSON(r),
              ...
              !i.find(".wow").length > 0 &&
                i.find(".grid-item").css("visibility", "hidden"),
                i.imagesLoaded(function () {
                  !i.find(".wow").length > 0
                    ? i.find(".grid-item").css("visibility", "")
                    : h || i.find(".grid-item").css("visibility", "hidden"),
  ...
  P ? ((P = "#" + P), (I = I.replace(P, ""))) : (I = I.replace("#", "")),
    ...
    t(document).on(
      ...
      function (e) {
        ...
        t(this)
          ...
          .each(function () {
            var e = t(this);
            e.parent().find(".menu-toggle").attr("data-bs-target") != a &&
              e.collapse("hide");
          }),
          t(".left-sidebar-wrapper .left-sidebar-nav")
            .parents("body")
  ...
  function A() {
    document
      .querySelectorAll(".swiper-container:not( .instafeed-wrapper )")
      .forEach(function (e, a) {
        ...
        if (null != i) {
          ...
          if ("" != i.thumbs && null != i.thumbs) {
            ...
            if ("" != l && null != l) {
              var c =
                "" != i.thumbs.swiper.direction &&
                null != i.thumbs.swiper.direction
                  ? i.thumbs.swiper.direction
                  : l;
              i.thumbs.swiper.on = {
                init: function () {
  ...
  function B() {
    for (var e = 0; e < d.length; e++) {
      ...
      "" != a &&
        null != a &&
        (N() <= a ? t.destroy(!1, !0) : t.destroyed && (d.splice(e, 1), A()));
    }
  }
  function L() {
    setTimeout(function () {
  ...
  function W(e) {
    t(".overlap-section-bottom").length > 0 && N() >= 768
  ...
  function U() {
    ...
    (!t(".navbar").hasClass("top-space") &&
      ...
      t(".mobileoff-fullscreen-top-space").length >= 0 &&
        N() > 1023 &&
        t(".mobileoff-fullscreen-top-space").css("height", z() - e + "px"),
      t(".fullscreen-top-space").length >= 0 &&
        t(".fullscreen-top-space").css("height", z() - e + "px"),
      (t(".sidebar-nav-action").length > 0 ||
        t(".side-menu-header").length > 0) &&
        (N() <= i
          ? t("body").css("padding-top", e + "px")
            ...
            ((function (e) {
              ...
              if (e.hasClass("simple-dropdown")) {
                ...
                var a =
                  t -
                  30 -
                  (e.offset().left + e.children(".dropdown-menu").outerWidth());
